...
- If you don't wish to manually update your local WARDEN sytem after every build, you may symlink this development folder with your Foundry data folder. This can be done manually or by running `npm run link` and following the instructions.
